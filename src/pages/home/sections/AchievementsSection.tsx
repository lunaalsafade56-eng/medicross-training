...
import bgdoctor from"../../../assets/images/ab2.png"
const AchievementsSection: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 bg-linear-to-b from-white to-[#f1f7fb] mx-5 my-8  pb-0 font-sans">
      {/* القسم الأول */}
      <div className="flex flex-col gap-7 items-start  mt-32 text-start">
        <div>
      ...
      <div className="flex flex-col items-center   relative" >
        ...
        <img
          src= {imageDoctor}
          alt="Placeholder"
          className=" w-auto h-auto mt-5 pt-30 rounded-2xl "style={{backgroundImage:`url(${bgdoctor}) `}}
        />
       
      </div>

      {/* القسم الثالث */}
      <div className="flex flex-col items-start text-start mt-32 mx-3">
